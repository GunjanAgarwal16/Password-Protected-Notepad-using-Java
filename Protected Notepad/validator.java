...
public class validator implements ActionListener {
    ...
    public static void main(String args[]) {
        ...
        info = new JLabel(
                "<html>Your password should be atleast 8 characters long<br/>and contain atleast one Uppercase letter,<br/>one Lowercase letter, one Number and one Special Character</html>");
    ...
    public void actionPerformed(ActionEvent e) {
        String message = "";
        char[] password = passwordText.getPassword(); // getPassword() method returns the typed password as a character
                                                      // array
